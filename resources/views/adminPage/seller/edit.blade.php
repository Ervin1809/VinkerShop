...
@section('contentAdmin')
        ...
        <div class="w-full max-w-4xl">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-8">
                    <h2 class="text-3xl font-bold text-white text-center">Edit Seller Account</h2>
                    <p class="text-white/80 text-center mt-2">Update seller account information</p>
                </div>

                <!-- Form Section -->
                <div class="p-8">
                    <form action="{{ route('adminPageSeller.update', $seller->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    required value="{{ $seller->name }}" placeholder="Enter full name">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email"
                                    class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-200"
                                    required value="{{ $seller->email }}" placeholder="Enter email address">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="shopName" id="shopName"
                                    class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-200"
                                    required value="{{ $seller->shop->shopName }}" placeholder="Enter shop name">
                            </div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <input type="tel" name="phone" id="phone"
                                    class="form-input w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-200"
                                    required value="{{ $seller->phone }}" placeholder="Enter phone number (e.g., 082-333-444-555)">
                            </div>
                        </div>
    ...
    <!-- Keep existing password toggle script -->
    <script>
