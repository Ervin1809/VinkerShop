    ...
    <div class="max-w-screen-xl flex items-center justify-between mx-auto py-3 px-4">
        ...
        <a href="#" class="flex items-center group hover:opacity-90 transition-opacity duration-200">
            ...
            <div class="ml-3 flex flex-col justify-center">
                ...
                <span class="text-xs font-medium text-gray-600">Seller Center</span>
            </div>
        </a>

        <div class="flex items-center space-x-6">
            <div class="flex items-center">
                <a href="{{ route('seller.settings.index') }}" class="px-4 py-2 rounded-full bg-gradient-to-r from-purple-50 to-indigo-50
