            ...
            <div class="bg-white rounded-lg shadow-md mb-4 p-4 opacity-0 transform translate-y-4 transition-all duration-500 order-card">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="text-right">
                        ...
                        <span class="inline-block px-4 py-2 rounded-3xl text-sm font-medium bg-blue-100 text-blue-700 border border-blue-200">
                ...
                <div class="text-center mt-4 border-t pt-4">
                    <form action="{{ route('orders.complete', $order) }}" method="POST" class="inline">
                        @csrf
                        @method('PATCH')
                        <button type="submit" class="px-6 py-2 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors">
                            Mark as Completed
                        </button>
                    </form>
                </div>
