...
<body class="font-sans text-gray-900 antialiased bg-gray-50">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center py-6 sm:py-0">
        ...
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6 sm:p-8">
            <h2 class="text-xl font-semibold text-center text-gray-800 mb-6">Login to Your Account</h2>
            ...
            <p class="text-sm text-gray-600 mt-4 text-center">
                ...
                <a href="{{ route('chooseType.create') }}" class="text-[#915cfc] hover:underline">Sign up here</a>
            </p>
        </div>
    </div>
