...
<body class="font-sans text-gray-900 antialiased bg-gray-50">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center py-6 sm:py-0">
        ...
        <!-- Registration Card -->
        <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 sm:p-8">
            <h2 class="text-xl font-semibold text-center text-gray-800 mb-6">Create Your Account Seller</h2>
            <form action="{{ route('registerSeller.store') }}" method="POST">
                @csrf
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="shopName" id="shopName"
                            ...
                            placeholder=" " required />
                        <label for="shopName"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Shop
                            Name
                        </label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
